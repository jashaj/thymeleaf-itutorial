...
public class DynamicViewController {
    private static final Logger LOG = LoggerFactory.getLogger(DynamicViewController.class);
    
    private final ServletContext servletContext;
    private final MessageSource messageSource;

  @Autowired
    public DynamicViewController(final ServletContext servletContext, final MessageSource messageSource) {
    ...
    private String generateCodeOrError(final HttpServletRequest request, final HttpServletResponse response, 
        ...
        try {
            ...
            LOG.debug("Error processing template", ex);
